...
def handle(msg):
    ...
    if texto == '/start':
        if chat_type == 'private':
            bot.sendMessage(chat_id, "Eu sou o BotBasic, fui desenvolvido em Python pelo @SrBiggs! \n\n Obrigado por se inscrever!")
